...
from geometry.utils import Array, unique_rows_2d, unitize
from geometry.formats import stl
...
class TriangleMesh(Geometry):
    ...
    def load(cls, path: str, **kwargs):
        return type(cls)(*stl.load(path, **kwargs))
    
    def save(self, path: str, **kwargs):
        stl.save(path, self.vertices, self.faces, **kwargs)
...
class Vertices(Points):
    ...
    def __array_finalize__(self, obj):
        obj = super().__array_finalize__(obj)
    ...
    @property
    def referenced(self):
        """(n,) bool array of whether each vertex is part of the complex."""
